// ABI del contrato BlackBoxx (versión Solidity 0.8.20)
const contractABI = [
  {
    "inputs": [],
  ...
  },
  {
    ...
    "inputs": [
      ...
      { "indexed": false, "internalType": "uint256", "name": "eggsBought", "type": "uint256" }
    ],
    "name": "EggsBought",
    "type": "event"
  },
  {
    ...
    "inputs": [
      ...
      { "indexed": false, "internalType": "uint256", "name": "newMiners", "type": "uint256" }
    ],
    "name": "EggsHatched",
    "type": "event"
  },
  {
    ...
    "inputs": [
      { "indexed": true, "internalType": "address", "name": "player", "type": "address" },
      { "indexed": false, "internalType": "uint256", "name": "eggsSold", "type": "uint256" },
  ...
  },
  {
    "anonymous": false,
    "inputs": [
      { "indexed": false, "internalType": "uint256", "name": "initialEggs", "type": "uint256" }
    ],
    "name": "MarketSeeded",
    "type": "event"
  },
